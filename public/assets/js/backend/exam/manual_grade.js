define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'exam/manual_grade/index' + location.search,
                    add_url: 'exam/manual_grade/add',
                    edit_url: 'exam/manual_grade/edit',
                    del_url: 'exam/manual_grade/del',
                    multi_url: 'exam/manual_grade/multi',
                    import_url: 'exam/manual_grade/import',
                    table: 'exam_manual_grade_log',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'kind', title: __('Kind'), searchList: {"PAPER":__('Paper'),"ROOM":__('Room')}, formatter: Table.api.formatter.normal},
